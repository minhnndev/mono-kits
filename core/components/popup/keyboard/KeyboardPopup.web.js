...
export default class KeyboardPopup extends Component {
  ...
  onBottomMessagePress = () => {
    ...
    if (onBottomMessagePress && typeof onBottomMessagePress === 'function')
      onBottomMessagePress();
  };
  ...
  render() {
    const {value, centerMessage} = this.state;
    const {
      maxLength,
      title,
      bottomMessage,
      ...
      <View style={styles.container}>
        ...
        <View style={styles.inputViewContainer}>
          ...
          <View style={styles.centerMessageView}>
            <Text style={[styles.centerMessage, centerMessageStyle]}>
              {centerMessage || ' '}
            </Text>
          </View>
          <TouchableOpacity
            onPress={this.onBottomMessagePress}
            activeOpacity={0.5}>
            <Text style={[styles.bottomMessage, bottomMessageStyle]}>
              {bottomMessage}
            </Text>
          </TouchableOpacity>
        </View>
