...
const serviceHeader = [
  {
    ...
    icon: {
      active:
        'https://cdn.mservice.com.vn/app/img/kits/navigation_remove_from_home.png',
      inactive:
  ...
  },
  {
    ...
    icon: {
      active:
        'https://img.mservice.com.vn/momo_app_v2/new_version/img/appx_icon/24_gadgets_iphone.png',
      inactive:
        'https://img.mservice.com.vn/momo_app_v2/new_version/img/appx_icon/24_gadgets_iphone.png',
    },
    title: {
  ...
  },
  {
    ...
    icon: {
      active:
        'https://img.mservice.com.vn/momo_app_v2/new_version/img/appx_icon/24_time_clock_reset.png',
      inactive:
        'https://img.mservice.com.vn/momo_app_v2/new_version/img/appx_icon/24_time_clock_reset.png',
    },
    title: {
  ...
  },
  {
    ...
    icon: {
      active:
        'https://img.mservice.com.vn/momo_app_v2/new_version/img/appx_icon/24_connection_share.png',
      inactive:
        'https://img.mservice.com.vn/momo_app_v2/new_version/img/appx_icon/24_connection_share.png',
    },
    title: {
...
const serviceFooter = [
  {
    ...
    icon: {
      active:
        'https://cdn.mservice.com.vn/app/icon/kits/notifications_info.png',
      inactive:
        'https://cdn.mservice.com.vn/app/icon/kits/notifications_info.png',
    },
    title: {
  ...
  },
  {
    ...
    icon: {
      active:
        'https://cdn.mservice.com.vn/app/img/kits/notifications_guide.png',
      inactive:
        'https://cdn.mservice.com.vn/app/img/kits/notifications_guide.png',
    },
    title: {
  ...
  },
  {
    ...
    icon: {
      active:
        'https://cdn.mservice.com.vn/app/icon/kits/travel_suport_service.png',
      inactive:
        'https://cdn.mservice.com.vn/app/icon/kits/travel_suport_service.png',
    },
    title: {
...
export {serviceFooter, serviceHeader};
