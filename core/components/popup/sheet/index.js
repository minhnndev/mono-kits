    ...
    <View style={styles.header}>
      <View style={styles.headerRow}>
        ...
        <View style={{justifyContent: 'center'}}>
          <Text color={Colors.black_17} weight="bold">
            {title}
          </Text>
          {subTitle && <Text color={Colors.black_12}>{subTitle}</Text>}
        </View>
      </View>
        ...
        return existService || existExtend ? (
          <TouchableOpacity
            ...
            <View style={styles.iconContainter}>
              <Image
                style={styles.image}
                tintColor={Colors.black_12}
                source={
                  item.icon[
                    existService?.status || existExtend?.status || item?.status
                  ]
                }
              />
            </View>
