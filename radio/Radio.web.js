...
export default class Radio extends Component {
    render() {
        const {
            disable, selected, hideTitle, valueStyle, value, onPress, disableOnChange, style, radioStyle
        } = this.props;
        let customStyle = {};
        let customTitle = {};
        let customDotStyle = {};
        ...
        return (
            <TouchableOpacity style={style} disabled={disable || disableOnChange} onPress={onPress}>
                <View style={styles.row}>
                    <View style={[styles.radioButtonSize, styles.defaultRadioButton, radioStyle, customStyle]}>
                        <View style={[styles.centerDot, customDotStyle]} />
                    </View>
                    {!hideTitle ? (
                        <Text.Title style={[styles.textContent, ValueUtil.extractStyle(valueStyle), customTitle]}>
                            {value}
                        </Text.Title>
                    ) : <View />}
                    {!isEmpty(imageUrl)
